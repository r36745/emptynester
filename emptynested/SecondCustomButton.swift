...
//  Emptynesters v1.0
//
//  Created by Steven Roseman on 2/13/16.
...
@IBDesignable class LivelyDesignedButton: UIButton {
    
    // IBInspectable properties for the gradient colors
    @IBInspectable var bottomColor: UIColor = UIColor(red:191.0/255.0, green:25.0/255.0, blue:85.0/255.0, alpha:1)
    @IBInspectable var middleColor: UIColor = UIColor(red:191.0/255.0, green:15.0/255.0, blue:85.0/255.0, alpha:1)
    @IBInspectable var topColor: UIColor = UIColor(red:191.0/255.0, green:25.0/255.0, blue:85.0/255.0, alpha:1)
...
@IBDesignable class LivelyDesignedView: UIView {
