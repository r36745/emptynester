...
@IBDesignable class DesignableButton: UIButton {
    ...
    @IBInspectable var bottomColor: UIColor = UIColor(red:0.07, green:0.21, blue:0.45, alpha:1)
    @IBInspectable var middleColor: UIColor = UIColor(red:0.07, green:0.21, blue:0.45, alpha:1)
    @IBInspectable var topColor: UIColor = UIColor(red:0.07, green:0.21, blue:0.45, alpha:1)
